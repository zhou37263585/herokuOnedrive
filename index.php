...
<?php                       if ($_SERVER['admin']) { ?>
                            ...
                            <ul>
								...
								<img class="operate_ico operate_ico_encrypt" src='data:img/jpg;base64,
...
<?php
    if ($_SERVER['admin']) {
		...
		<div id="encrypt_div" class="disLogBg" style="display:none">
			<div class="disLogBody" style="height: 120px;">
				<img class="disLog_btn_close" onclick="closeDisLog(this)" src="data:image/png;base64,">
				<?php if (getenv('passfile')!='') {?><div class="titleText" id="encrypt_label"></div>
				<?php } else { ?><div class="titleText"><?php echo $constStr['SetpassfileBfEncrypt'][$constStr['language']]; ?></div>
				<?php } ?>
				<form id="encrypt_form" onsubmit="return submit_operate('encrypt');">
					...
					<div class="form-group" style="padding-top: 5%;">
						<?php if (getenv('passfile')!='') {?><input class="form-field basic-style" id="encrypt_input" name="encrypt_newpass" type="text" placeholder="<?php echo $constStr['InputPasswordUWant'][$constStr['language']]; ?>" />
						<span class="basic-style" onclick="document.getElementById('encrypt_operate_action').click();">
						<?php echo $constStr['encrypt'][$constStr['language']]; ?></span><?php }?>
