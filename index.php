...
.operate_ico_encrypt{
	text:expression(src="'data:img/jpg;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAABOElEQVQ4T9XSsU3DQBQG4P/ZICEq
...
<?php                       if ($_SERVER['admin']) { ?>
                            ...
                            <ul>
								...
								<img class="operate_ico operate_ico_encrypt" style="background-image:url();"> &nbsp;</img>
									<?php echo $constStr['encrypt'][$constStr['language']]; ?></a>
								</li>
