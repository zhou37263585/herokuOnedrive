...
<?php if ($_SERVER['admin']) { ?>
        ...
        .operate ul{position:absolute;display:none;background: white;border:1px #1296db solid;border-radius:5px;margin: -9px 0 0 0;padding:0 5px;color:#205D67;z-index: 2;}
