			...
			<div class="disLogBody" style="height: 120px;">
				...
				<form id="rename_form" onsubmit="return submit_operate('rename');">
					...
					<div class="form-group" style="padding-top: 5%;">
						...
						<span class="basic-style" name="operate_action" onclick="document.getElementById('rename_form').submit();" value="<?php echo $constStr['Rename'][$constStr['language']]; ?>"><?php echo $constStr['Rename'][$constStr['language']]; ?></span>
					</div>
				</form>
			</div>
		</div>
		<div id="delete_div" class="disLogBg" style="display: none;">
			<div class="disLogBody">
				...
				<form id="delete_form" onsubmit="return submit_operate('delete');">
					<div class="disLog_btn_submit" tabindex="1" name="operate_action" id="delete_input" onclick="document.getElementById(delete_form).submit();" value="<?php echo $constStr['Submit'][$constStr['language']]; ?>"><?php echo $constStr['Submit'][$constStr['language']]; ?></div>
