...
<?php if ($_SERVER['admin']) { ?>
        ...
        .operate ul{position:absolute;display:none;background: white;border:1px #1296db solid;border-radius:5px;padding:0 5px;color:#205D67;z-index: 2;}
        .operate:hover ul{position:absolute;display:inline-table;}
        .operate ul li{padding: 0 6px;list-style:none;display:inline-table;}
