    ...
    <div>
        ...
        <div id="delete_div" class="disLogBg" style="display:none">
			<div class="disLogBody">
				...
				<div class="titleText">
					<?php echo $constStr['Delete'][$constStr['language']]; ?>?
				</div>
				...
				<form id="delete_form" onsubmit="return submit_operate('delete');">
					...
					<div class="disLog_btn_submit" onclick="document.getElementById('delete_form').submit();"><?php echo $constStr['Submit'][$constStr['language']]; ?></div>
				</form>
			</div>
		</div>
