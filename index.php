    ...
    if ($_SERVER['admin']) {
		...
		<div id="rename_div" class="disLogBg" style="display:none">
			<div class="disLogBody" style="height: 120px;">
				...
				<div class="titleText" id="rename_titleText"></div>
				<form id="rename_form" onsubmit="return submit_operate('rename');">
					...
					<div class="form-group" style="padding-top: 5%;">
						<input class="form-field basic-style" id="rename_input" name="rename_newname" type="text" onchange="document.getElementById('rename_form').submit();" placeholder="<?php echo $constStr['InputPassword'][$constStr['language']]; ?>" />
						<span class="basic-style"><?php echo $constStr['Rename'][$constStr['language']]; ?></span>
					</div>
				</form>
			</div>
		</div>
...
<?php   if (!$_GET['preview']) {?>
    function showdiv(event,action,num) {
        ...
        if (action=='rename') document.getElementById(action + '_titleText').innerHTML=str;
